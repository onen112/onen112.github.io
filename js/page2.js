var app = new Vue({
    ...
    data:{
        sArr:[
            {sName:"张三",sC:91,sM:100,sE:101,sP:72,sCm:69,sB:80,sAdd:0},
            {sName:"李四",sC:99,sM:121,sE:88,sP:69,sCm:81,sB:57,sAdd:0},
            {sName:"王五",sC:105,sM:101,sE:99,sP:82,sCm:63,sB:71,sAdd:0},
            {sName:"王麻子",sC:93,sM:99,sE:84,sP:69,sCm:88,sB:71,sAdd:0}
        ],
    ...
    methods: {
        ...
        add:function () {
            ...
            // }
            for(var i = 0;i < this.sArr.length;i++){
                this.sArr[i].sAdd = this.sArr[i].sC + this.sArr[i].sM + this.sArr[i].sE + this.sArr[i].sP + this.sArr[i].sCm + this.sArr[i].sB;
            }
        },
        print:function () {
            console.log(this.px);
        ...
        addStu:function () {
            if(this.addArr.sC == null){
                alert("添加失败，请输入正确的信息！");
                this.addArr = [{sName: "", sC: 0, sM: 0, sE: 0, sP: 0, sCm: 0, sB: 0, sAdd: 0}];
            }else {
